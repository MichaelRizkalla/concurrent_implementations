...
#define CONCURRENT_VECTOR_ALLOCATOR_ERROR_MESSAGE(concurrent_vector_type, type) \
    ...
    class concurrent_vector {
        static_assert(std::is_same_v< Type, typename Allocator::value_type >,
                      CONCURRENT_VECTOR_ALLOCATOR_ERROR_MESSAGE("concurrent_vector<T, Allocator>", "T"));
      ...
      private:
        ...
        static constexpr size_type Min_segment_size =
            impl::Min_segment_size_eval< Type, size_type >::value; // Arbitrary starting size ~ 1KB
